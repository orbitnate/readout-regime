...
\textbf{The readout-regime install.} A readout install is a finite set of \emph{slots}
\[ S = \{(t_1,K_1,\alpha_1), \dots, (t_m,K_m,\alpha_m)\}, \]
...
{\footnotesize
\begin{longtable}{p{2.6cm}p{2.3cm}p{4.8cm}p{2.6cm}}
\toprule
